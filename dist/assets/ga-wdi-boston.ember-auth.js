...
define('client-play-log/config/environment', ['ember'], function(Ember) {
  var prefix = 'client-play-log';
/* jshint ignore:start */
...
if (!runningTests) {
  require("client-play-log/app")["default"].create({"name":"ga-wdi-boston.ember-auth","version":"0.0.0+fff17a0a"});
}
